 ...
 */
public class CacheConcurrentImplTest extends IMADPCoreTestCase {
	Long key;
	Boolean value;
	...
	public void before() throws Exception {
		...
		cache = cacheManagerConcurrent.getCache(cacheName);
	...
	@Test
	public void softValueMemoryClearing() {
		assertNull(cache.get(key));
