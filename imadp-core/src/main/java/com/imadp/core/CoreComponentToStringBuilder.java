...
/**
 * CoreComponentToStringBuilder
 * 
 * Extention of the ReflectionToStringBuilder to build CoreComponent toString implementations.
 * 
 * @version 1.0
 * @author Anthony DePalma
 */
public class CoreComponentToStringBuilder extends ReflectionToStringBuilder {
	 ...
	 * @return String
	 */
	public static String reflectionToString(CoreComponent component) {
		return new CoreComponentToStringBuilder(component).toString();
	}
	...
	// constructor
	private CoreComponentToStringBuilder(Object object) {
		...
		for (int i = 0; i < fields.length; i++)
		{
			...
			if (this.accept(field))
			{
				try
				{
					...
					this.append(fieldName, fieldValue instanceof CoreComponent ? 
							((CoreComponent)fieldValue).getSimpleToString() : fieldValue);
				}
