        ...
        options.toNonEditable = function ($this, change) {
            ...
            $this.one(opts.editBy, opts.toEditable)
                .data('editable.current',
                    change ? $.editableFactory[opts.type].getValue($this, opts) : $this.data('editable.current')
            )
                .html(
                    opts.type == 'password' ? '*****' : $this.data('editable.current')
            );
            // Call User Function
            var func = null;
        ...
        'select': {
            toEditable: function ($this, options) {
                ...
                $.each(options.options, function (key, option) {
                    ...
                    if(option.value == options.selectValue)
