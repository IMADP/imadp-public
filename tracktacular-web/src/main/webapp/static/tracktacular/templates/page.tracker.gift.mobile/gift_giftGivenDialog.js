	...
	{<dialogFormBody}
		...
		<div class="sh1">Add a gift you've been given.</div> 
		
		<label for="gift.name" class="primary required">Gift Name</label>
		{#. object="gift.name" max="256"}{>inputText/}{/.}
		
		<label for="gift.sender" class="primary required">From</label>
		<label for="gift.sender" class="secondary">Who gave this gift to you?</label>
		{#. object="gift.sender" max="256"}{>inputText/}{/.}
