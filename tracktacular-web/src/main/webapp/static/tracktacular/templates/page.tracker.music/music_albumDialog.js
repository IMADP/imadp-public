	...
	{<dialogFormBody}
		...
		<label for="album.tag" class="secondary">Add tags a comma separated list (ie: alternative, pop, running music)</label>  
		...
		<div class="cf">
			...
			<div class="half">
				...
				<label for="album.targetDate" class="secondary">An optional target date to listen</label>  
