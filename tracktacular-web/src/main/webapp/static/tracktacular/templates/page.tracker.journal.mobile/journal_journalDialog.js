	...
	{<dialogFormBody}
		...
		<label for="journal.alertRecurrence.length" class="primary">Create an alert if a journal hasn't been entered in {~s}</label>
		{#. object="journal.alertRecurrence.length" min="0"}{>inputNumber/}{/.}
