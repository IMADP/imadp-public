<%@ include file="/WEB-INF/jsp/includeJsp.jsp" %>
	...
	<%-- Completed Page Data --%>
	<j:property name="completedGoalsCount" value="${actionBean.itemsPageProvider.page.itemCount}"/>
	
	<j:array var="goal" name="completedGoals" items="${actionBean.itemsPageProvider.page.items}" >
		<j:object>
