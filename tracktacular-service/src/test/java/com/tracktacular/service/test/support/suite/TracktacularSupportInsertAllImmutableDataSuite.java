...
/**
 * TracktacularSupportInsertAllImmutableDataSuite
 * 
 * This suite provides a fresh database with all immutable data.
 * 
 * @version 1.0
...
public class TracktacularSupportInsertAllImmutableDataSuite {
