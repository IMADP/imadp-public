<%@ tag description="Tag providing joda DateTime formatting" pageEncoding="UTF-8"%>
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
<%@ taglib prefix="c"  	uri="http://java.sun.com/jsp/jstl/core" %>

<%@ attribute name="value"      rtexprvalue="true" required="false"  type="org.joda.time.ReadableInstant" %>
...
<%@ attribute name="pattern"    rtexprvalue="true" required="true" %>
	...
	<c:if test="${value != null}">
		<jsp:setProperty name="dateBean" property="time" value="${value.millis}" />
	</c:if>
