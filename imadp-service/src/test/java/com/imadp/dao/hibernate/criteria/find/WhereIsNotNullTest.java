 ...
 */
@Transactional
public class WhereIsNotNullTest extends IMADPServiceTestCase {
	...
	public void before() throws Exception {
		...
		samplePersistable.setDescription(null);
	...
	public void persistableValueEqualToTestedValue() throws Exception {		
		findCriteria = samplePersistableDao.findCriteriaBuilder(Results.ALL)
			.whereIsNotNull(SamplePersistable.NAME).build();
	...
	public void persistableValueNotEqualToTestedValue() throws Exception {		
		findCriteria = samplePersistableDao.findCriteriaBuilder(Results.ALL)
			.whereIsNotNull(SamplePersistable.DESCRIPTION).build();
