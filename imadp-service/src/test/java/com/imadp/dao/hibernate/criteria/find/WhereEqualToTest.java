 ...
 */
@Transactional
public class WhereEqualToTest extends IMADPServiceTestCase {
	...
	public void persistableValueEqualToTestedValue() throws Exception {		
		findCriteria = samplePersistableDao.findCriteriaBuilder(Results.ALL)
			.whereEqualTo(SamplePersistable.NAME, samplePersistable.getName()).build();
	...
	public void persistableValueNotEqualToTestedValue() throws Exception {		
		findCriteria = samplePersistableDao.findCriteriaBuilder(Results.ALL)
			.whereEqualTo(SamplePersistable.NAME, StringUtils.EMPTY).build();
